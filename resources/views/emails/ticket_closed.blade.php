...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p>Te informamos que el ticket <strong>{{ $ticket->ticket_number }}</strong> ha sido cerrado por{{ $ticket->assigned }}. A continuación, te compartimos los detalles:</p>

            <div class="ticket-info">
                <p><strong>Estado:</strong> <span class="status-badge">Cerrado</span></p>
                ...
                <p><strong>Cerrado por:</strong> {{ $ticket->assigned }}</p>
                <p><strong>Fecha de Creación:</strong> {{ $ticket->created_at }}</p>
                <p><strong>Fecha de Cierre:</strong> {{ $ticket->updated_at }}</p>
                <p><strong>Observaciones Finales:</strong> {{ $ticket->final_observations }}</p>
            </div>
        </div>
