          ...
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <form action="{{ route('register.save') }}" method="POST" class="user">
                ...
                <div class="form-group">
                  <input name=telephone" type="post" class="form-control form-control-user @error('post')is-invalid @enderror" id="exampleInputEmail" placeholder="Telefono">
                  @error('email')
                    <span class="invalid-feedback">{{ $message }}</span>
                  @enderror
                </div>
                <div class="form-group">
                  <input name="address" type="address" class="form-control form-control-user @error('address')is-invalid @enderror" id="exampleInputEmail" placeholder="Direccion">
                  @error('email')
                    <span class="invalid-feedback">{{ $message }}</span>
                  @enderror
                </div>
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input name="password_confirmation" type="password" class="form-control form-control-user @error('password_confirmation')is-invalid @enderror" id="exampleRepeatPassword" placeholder="Repetir Contraseña">
